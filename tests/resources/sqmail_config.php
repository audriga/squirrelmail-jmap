...
$domain                 = 'audriga.eu';
$imapServerAddress      = 'wp13405851.mail.server-he.de';
$imapPort               = 993;
$useSendmail            = false;
$smtpServerAddress      = 'wp13405851.mailout.server-he.de';
$smtpPort               = 465;
...
$data_dir                 = SM_PATH . 'localdata/';
$attachment_dir           = SM_PATH . 'localattach/';
$dir_hash_level           = 0;
...
$plugins[2] = 'calendar';
//$plugins[3] = 'calendar_file_backend';
//$plugins[4] = 'todo';
//$plugins[5] = 'notes';
//$plugins[6] = 'bookmarks';
